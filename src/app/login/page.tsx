    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-background to-secondary p-4">
      <Card className="w-full max-w-md shadow-2xl">
        <CardHeader className="text-center">
          ...
          <CardTitle className="font-headline text-3xl">Milionne's Academic Edge</CardTitle>
          <CardDescription>Secure Access Portal</CardDescription>
        </CardHeader>
        <CardContent className="flex flex-col items-center gap-6">
            <p className="text-center text-muted-foreground">
                Please use biometric authentication to access your academic dashboard.
            </p>
            <div className="relative h-32 w-32">
                <Image src="https://placehold.co/128x128/f1e6fc/be29ec" alt="Biometric Scan Area" data-ai-hint="fingerprint scan" layout="fill" className="rounded-full" />
            </div>
        </CardContent>
        <CardFooter>
          <Button onClick={handleSecureLogin} disabled={isLoading} className="w-full" size="lg">
            ...
            {isLoading ? 'Authenticating...' : 'Authenticate with Gemini Secure'}
          </Button>
        </CardFooter>
      </Card>
    </div>
