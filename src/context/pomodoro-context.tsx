...
export function PomodoroProvider({ children }: { children: ReactNode }) {
    ...
    return (
        <PomodoroContext.Provider value={{ time, mode, isActive, pomodoros, activeCourseId, times, toggleTimer, resetTimer, switchMode, startTimerForCourse }}>
            {children}
